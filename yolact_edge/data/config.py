...
MY_COCO_CLASSES = ('road')

MY_COCO_LABEL_MAP = {1: 1}
...
my_coco_dataset = dataset_base.copy({
    'name':'my coco',

    'train_info':'./data/factory/train/annotation/train.json',
    'train_images':'./data/factory/train/image',

    'valid_info': './data/factory/test/annotation/test.json',
    'valid_images': './data/factory/test/image',

    'label_map': MY_COCO_LABEL_MAP,

    'class_names': MY_COCO_CLASSES
...
yolact_edge_my_coco_config = yolact_base_config.copy({
    'name':'yolact_edge_my_coco',
    
    'dataset':my_coco_dataset,

    'num_classes': len(my_coco_dataset.class_names)+1,
...
cfg = yolact_edge_my_coco_config.copy()
